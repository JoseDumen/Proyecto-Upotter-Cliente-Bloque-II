...
function cargarTablaListaUsuarios()
{
    let oAreaListaUsuarios = document.querySelector("#areaListadoUsuarios table");
    if(oAreaListaUsuarios !=null)
    {
        oAreaListaUsuarios.remove();
    }
    let oTablaDesplegada = pintaTablaListarUsuarios();
    oAreaListaUsuarios = document.querySelector("#areaListadoUsuarios");
    oAreaListaUsuarios.appendChild(oTablaDesplegada);
}